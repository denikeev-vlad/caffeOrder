...
public class CreateOrderActivity extends AppCompatActivity {
    ...
    private String drink; //Тут будем хранить имя выбранного напитка
    private StringBuffer builderAdditions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra("name") && intent.hasExtra("password")) { //Если пароль и имя не пришли, то присвоить по дефолту
        ...
        builderAdditions = new StringBuffer();
    }
    ...
    public void onClickSendOrder(View view) {
        builderAdditions.setLength(0); //если наш стрикг билдер уже имел какие-то значения, то очищаем его
        ...
        String optionOfDrink = ""; //Вид напитка из спиннера
